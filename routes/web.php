...
Route::group(['middleware' => ['XssSanitizer']], function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::get('/logout_all_doctors', [AdminController::class, 'logoutAllDoctors']);
        Route::get('/logout_all_patients', [AdminController::class, 'logoutAllPatients']);
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::get('/logout-user/{id}', [AdminController::class, 'logoutUser'])->name('logoutUser');
    ...
    Route::get('/pharmacy/send_otp/{id}', [App\Http\Controllers\Pharmacy\PharmacyController::class, 'send_otp']);
    Route::post('/pharmacy/verify_otp', [App\Http\Controllers\Pharmacy\PharmacyController::class, 'verify_otp']);
    Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/pathologist/send_otp/{id}', [LabSettingController::class, 'send_otp']);
    Route::post('/pathologist/verify_otp', [LabSettingController::class, 'verify_otp']);
